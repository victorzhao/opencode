...
export const dict = {
  ...
  "session.review.commit.messagePlaceholder": "Commit message",
  "session.review.commit.action": "Commit",
  "session.review.commit.actionLoading": "Committing...",
  "session.review.commit.success": "Changes committed",
  "session.review.commit.emptyMessage": "Enter a commit message",
  ...
  "settings.proxy.unavailable": "Proxy settings are unavailable on this server.",
  "settings.proxy.section.global": "Default proxy",
  "settings.proxy.global.title": "Proxy URL",
  "settings.proxy.global.description":
    "Default proxy for all model requests, e.g. http://127.0.0.1:7890. Supports http, https and socks proxies with optional user:password authentication. Leave empty to follow the HTTP_PROXY, HTTPS_PROXY and NO_PROXY environment variables.",
  "settings.proxy.global.placeholder": "http://127.0.0.1:7890",
  "settings.proxy.global.save": "Save",
  "settings.proxy.global.clear": "Clear",
  "settings.proxy.global.invalid": "Enter a valid proxy URL, e.g. http://127.0.0.1:7890",
  "settings.proxy.global.saved": "Proxy updated",
  "settings.proxy.global.restart": "Restart",
  "settings.proxy.global.restartHint": "The desktop app applies the default proxy at startup. Restart the app for the change to take effect.",
  "settings.proxy.section.providers": "Providers",
  "settings.proxy.providers.description":
    "Control whether each provider routes through the proxy. Models inherit the provider setting unless overridden below.",
  "settings.proxy.providers.empty": "No connected providers",
  "settings.proxy.mode.follow": "Use proxy",
  "settings.proxy.mode.direct": "Direct connection",
  "settings.proxy.section.models": "Models",
  "settings.proxy.models.description":
    "Override the proxy behavior for individual models. Off means the model always connects directly.",
