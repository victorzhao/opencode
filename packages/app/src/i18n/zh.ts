...
export const dict = {
  ...
  "session.review.commit.messagePlaceholder": "提交信息",
  "session.review.commit.action": "提交",
  "session.review.commit.actionLoading": "提交中...",
  "session.review.commit.success": "更改已提交",
  "session.review.commit.emptyMessage": "请输入提交信息",
  "session.review.commit.noChanges": "没有可提交的更改",
  "session.review.commit.generate": "AI 生成",
  "session.review.commit.generateLoading": "生成中...",
