...
export const dict = {
  ...
  "session.review.commit.messagePlaceholder": "提交訊息",
  "session.review.commit.action": "提交",
  "session.review.commit.actionLoading": "提交中...",
  "session.review.commit.success": "變更已提交",
  "session.review.commit.emptyMessage": "請輸入提交訊息",
  "session.review.commit.noChanges": "沒有可提交的變更",
